...
routes.get('/', function (req, res) {
    ...
    crud.Mongo().get('fruits', {}).then(function (respuesta) {
...
routes.get('/:name/:activo?', function (req, res) {
    ...
    //Capturo la respuesta del get 
    crud.Mongo().get('fruits', filtro).then(function (respuesta) {
        //Retorno la respuesta  al cliente
        res.send(respuesta)
    }).catch(function (error) {
        //Retorno el error al cliente
...
routes.post('/', function (req, res) {
    ...
    var body = req.body;
    crud.Mongo().insert('fruits', body).then(function(respuesta){
